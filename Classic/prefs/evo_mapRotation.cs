...
addRotationMap("Disjointed", CTF, 0, 1);
addRotationMap("FullCircle", CTF, 1, 1);
...
addRotationMap("TWL_Starfallen", CTF, 1, 1);
addRotationMap("TWL_SubZero", CTF, 1, 1);
...
addRotationMap("Fallout", CTF, 1, 1);
